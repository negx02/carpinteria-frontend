...
<template>
  <main class="step-container">
    ...
    <div class="grid-display">
      ...
      >
        <div class="card-ui">
          ...
          <div class="check-box">
            <svg v-if="store.acabado === item.id" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3">
    ...
    <div class="nav-bar-actions">
      <button @click="router.push('/materiales')" class="btn-back">REGRESAR</button>
      <button @click="irSiguiente" class="btn-next" :disabled="!store.acabado">SIGUIENTE PASO</button>
    </div>
  </main>
</template>
